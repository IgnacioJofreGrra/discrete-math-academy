    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="max-w-6xl mx-auto p-4 max-[359px]:p-3">
        ...
        <div className="mb-6">
          ...
          <h1 className="text-4xl max-[359px]:text-[1.65rem] font-bold text-gray-900 mb-2">Visualizaciones Interactivas</h1>
          <p className="text-lg max-[359px]:text-sm text-gray-600">Explora conceptos matemáticos con demostraciones visuales</p>
        </div>

        {/* Visualizations Tabs */}
        <Tabs defaultValue="venn" className="w-full">
          <TabsList className="grid w-full grid-cols-1 sm:grid-cols-3 h-auto gap-2 mb-6">
            <TabsTrigger value="venn" className="whitespace-normal text-xs sm:text-sm leading-tight py-2">Diagramas de Venn</TabsTrigger>
            <TabsTrigger value="euclid" className="whitespace-normal text-xs sm:text-sm leading-tight py-2">Algoritmo de Euclides</TabsTrigger>
            <TabsTrigger value="factors" className="whitespace-normal text-xs sm:text-sm leading-tight py-2">Factorización</TabsTrigger>
          </TabsList>

          {/* Venn Diagrams */}
          <TabsContent value="venn" className="space-y-6">
            <Card className="p-8 max-[359px]:p-4">
              <h2 className="text-2xl max-[359px]:text-lg font-bold text-gray-900 mb-6">Diagramas de Venn</h2>
              <p className="text-gray-700 max-[359px]:text-sm mb-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-[359px]:gap-4">
                {/* Union Example */}
                <div className="flex flex-col items-center">
                  <h3 className="text-lg max-[359px]:text-base font-semibold text-gray-900 mb-4">Unión: A ∪ B</h3>
                  <VennDiagram
                    setA={['1', '2', '3', '4']}
                    setB={['3', '4', '5', '6']}
                    title="A ∪ B = {1, 2, 3, 4, 5, 6}"
                  />
                  <p className="text-sm max-[359px]:text-xs text-gray-600 mt-4 text-center">
                ...
                <div className="flex flex-col items-center">
                  <h3 className="text-lg max-[359px]:text-base font-semibold text-gray-900 mb-4">Intersección: A ∩ B</h3>
                  <VennDiagram
                    setA={['1', '2', '3', '4']}
                    setB={['3', '4', '5', '6']}
                    title="A ∩ B = {3, 4}"
              ...
              <div className="mt-8 p-4 bg-blue-50 rounded-lg border border-blue-200">
                <p className="text-sm max-[359px]:text-xs text-gray-700">
          ...
          <TabsContent value="euclid" className="space-y-6">
            <Card className="p-8 max-[359px]:p-4">
              <h2 className="text-2xl max-[359px]:text-lg font-bold text-gray-900 mb-6">Algoritmo de Euclides</h2>
              <p className="text-gray-700 max-[359px]:text-sm mb-6">
              ...
              <div className="mt-8 p-4 bg-green-50 rounded-lg border border-green-200">
                <p className="text-sm max-[359px]:text-xs text-gray-700 mb-2">
                  <strong>¿Cómo funciona?</strong>
                </p>
                <ul className="list-disc list-inside space-y-1 text-sm max-[359px]:text-xs text-gray-700">
          ...
          <TabsContent value="factors" className="space-y-6">
            <Card className="p-8 max-[359px]:p-4">
              <h2 className="text-2xl max-[359px]:text-lg font-bold text-gray-900 mb-6">Factorización en Primos</h2>
              <p className="text-gray-700 max-[359px]:text-sm mb-6">
        ...
        {/* Additional Info */}
        <Card className="mt-8 p-6 max-[359px]:p-4 bg-white border-l-4 border-blue-500">
          <h3 className="text-lg max-[359px]:text-base font-semibold text-gray-900 mb-3">Aplicaciones en Ciencias de la Computación</h3>
          <ul className="space-y-2 text-gray-700 max-[359px]:text-sm">
            <li>
